...
|===
| 1. Download
| http://standalone.ccw-ide.org/ccw-win32.win32.x86.zip[Windows 32 Bits] / http://standalone.ccw-ide.org/ccw-win32.win32.x86_64.zip[Windows 64 Bits] +
http://standalone.ccw-ide.org/ccw-linux.gtk.x86.zip[Linux 32 Bits] / http://standalone.ccw-ide.org/ccw-linux.gtk.x86_64.zip[Linux 64 Bits] +
http://standalone.ccw-ide.org/ccw-macosx.cocoa.x86_64.zip[OS X 64 Bits]

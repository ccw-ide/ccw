...
public interface IClojureEditorActionDefinitionIds extends ITextEditorActionDefinitionIds {
	 ...
	 * (value <code>"ccw.ui.edit.text.clojure.goto.matching.bracket"</code>).
	 *
	 * @since 2.1
	 */
	 ...
	 * (value <code>"ccw.ui.edit.text.clojure.goto.previous.member"</code>).
	 *
	 * @since 2.1
	 */
	...
	/**
	 * Action definition ID of the Clojure (or edit ?) -> evaluate top level s expression or region action 
	 */

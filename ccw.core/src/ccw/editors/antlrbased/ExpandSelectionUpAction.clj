...
(defn- -init
  [#^AntlrBasedClojureEditor editor] [[ClojureEditorMessages/ExpandSelectionUpAction_label] (ref {:editor editor})])  

(defn- -post-init
  [#^ccw.editors.antlrbased.ExpandSelectionUpAction this editor]

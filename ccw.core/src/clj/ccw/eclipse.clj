...
(def ^{:author "Andrea Richiardi" }
  ...
  "Removes a preference listener. Under the hood, the simbol is simply
  bound to remove-property-listener, accepting an object to remove from
  and the actual listener to remove."
  remove-property-listener)

...
`0.25.1` released on May xx, 2014
...
Thus the "Headless Leiningen REPL" command has been ressuscited. You can find it in the Leiningen contextual menu, or invoke it via the kbd:[Alt+L H] Keyboard Shortcut.

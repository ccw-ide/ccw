...
/**
 * Handles Clojure editor font changes for Clojure source preview viewers.
 * 
 * @since 3.0
 */
public class ClojureSourcePreviewerUpdater {
    ...
    public ClojureSourcePreviewerUpdater(final SourceViewer viewer, final ClojureSourceViewerConfiguration configuration, final IPreferenceStore preferenceStore) {
        ...
        final IPropertyChangeListener propertyChangeListener= new IPropertyChangeListener() {
             ...
             */
            public void propertyChange(PropertyChangeEvent event) {
/* TODO               if (configuration.affectsTextPresentation(event)) {
